...
export async function PUT(
  ...
  try {
    ...
    // Check if the config belongs to this school
    const existingConfig = await prisma.latenessdeductionconfig.findUnique({
      where: { id: body.id },
    });

    if (!existingConfig || existingConfig.schoolId !== school.id) {
