...
import { Crown, BarChart3, Users, DollarSign, TrendingUp, Activity, Building2 } from "lucide-react";
...
export default function SuperAdminSchools() {
  ...
  const passwordStrengthText = (score: number) => {
    ...
    return { text: texts[score - 1] || "Very Weak", color: colors[score - 1] || "text-red-500" };
  };
